...
function getBackendUrl() {
  const backendUrl =
    process.env.KOVA_BACKEND_URL ?? process.env.NEXT_PUBLIC_KOVA_BACKEND_URL;

  if (!backendUrl) {
    throw new Error("KOVA_BACKEND_URL or NEXT_PUBLIC_KOVA_BACKEND_URL is not configured.");
  }
